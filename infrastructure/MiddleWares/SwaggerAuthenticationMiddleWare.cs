...
namespace Caffe.Infrastructure.MiddleWares;
...
public class SwaggerAuthenticationMiddleWare : IMiddleware
{
    ...
    {
        _password = configuration.GetValue<string>("Auth:Swagger:UserName");
        _userName = configuration.GetValue<string>("Auth:Swagger:Password");
    }
